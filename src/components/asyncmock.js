export const products = [
  {
    ...
    category: 'Adventure',
    description:
      'Crash Bandicoot 4: Its About Time is a 3D platforming video game published by Activision and developed by Toys for Bob. It is the fourth mainline title in the Crash Bandicoot series. It was first released on October 2nd, 2020 for the PlayStation 4, and Xbox One. And then in March 12th, 2021 for the PlayStation 5, Xbox Series X/S, Nintendo Switch, and on March 26th, 2021 for PC.',
    plataforms: [
      'PS4',
      'Xbox One',
      'PS5',
  ...
  },
  {
    ...
    category: 'Action',
    description:
      'Its story follows Lara Croft as she ventures into Siberia in search of the legendary city of Kitezh while battling the paramilitary organization Trinity, which intends to uncover the citys promise of immortality.',
  ...
  },
  {
    ...
    version: 'Wild Hunt',
    price: 17,
    img: 'https://areajugones.sport.es/wp-content/uploads/2019/02/The-Witcher-Sapkowski.jpeg',
    category: 'Action',
    description:
      'Its story follows Lara Croft as she ventures into Siberia in search of the legendary city of Kitezh while battling the paramilitary organization Trinity, which intends to uncover the citys promise of immortality.',
    plataforms: ['Xbox One', 'Xbox 360', 'PC', 'PS4', 'macOS', 'Google Stadia'],
  ...
  },
  {
    ...
    version: '',
    price: 10,
    img: 'https://asset.vg247.com/ready_or_not_new_header_2.jpg/BROK/thumbnail/1600x900/quality/100/ready_or_not_new_header_2.jpg',
    category: 'Action',
    description:
      'Its story follows Lara Croft as she ventures into Siberia in search of the legendary city of Kitezh while battling the paramilitary organization Trinity, which intends to uncover the citys promise of immortality.',
    plataforms: ['Xbox One', 'Xbox 360', 'PC', 'PS4', 'macOS', 'Google Stadia'],
  ...
  },
  {
    id: 9,
    name: 'Fall guys',
    version: 'Ultimate Knockout',
    price: 5,
    img: 'https://fs-prod-cdn.nintendo-europe.com/media/images/10_share_images/games_15/nintendo_switch_download_software_1/H2x1_NSwitchDS_FallGuysUltimateKnockout_image1600w.jpg',
    category: 'Action',
    description:
      'Its story follows Lara Croft as she ventures into Siberia in search of the legendary city of Kitezh while battling the paramilitary organization Trinity, which intends to uncover the citys promise of immortality.',
    plataforms: ['Xbox One', 'Xbox 360', 'PC', 'PS4', 'macOS', 'Google Stadia'],
  ...
  {
    id: 10,
    name: 'Risk of the rain 2',
    version: '',
    price: 10,
    img: 'https://news.cdmarket.com.ar/wp-content/uploads/2020/08/risk-of-rain-2-final-boss-mithrix-owns.jpg',
    category: 'Action',
    description:
      'Its story follows Lara Croft as she ventures into Siberia in search of the legendary city of Kitezh while battling the paramilitary organization Trinity, which intends to uncover the citys promise of immortality.',
    plataforms: ['Xbox One', 'Xbox 360', 'PC', 'PS4', 'macOS', 'Google Stadia'],
